...
cmd='HCopy -C mfcc26.cfg -S output\wav2fea.scp';
dos(cmd);
...
cmd='outMacro.exe P D 3 1 MFCC_E_D_Z 26 > output\template.hmm';
%cmd='outMacro.exe P D 7 1 MFCC_E_D_Z 26 > output\template.hmm';
...
cmd='HResults -p -I output\answer.mlf digitSyl.pam output\result_test_no_sil.mlf > output\outsideTest10.txt';
dos(cmd);


type output\outsideTest10.txt
